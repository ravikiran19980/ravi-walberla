...
class ParticleStorage():
    def __init__(self):
        ...
        self.add_property("position", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ALWAYS")
        self.add_property("interactionRadius", "walberla::real_t", defValue="0_r", syncMode="ON_GHOST_CREATION")
