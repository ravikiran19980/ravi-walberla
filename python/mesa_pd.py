...
if __name__ == '__main__':
    ...
    ps.add_property("position", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ALWAYS")
    ps.add_property("linearVelocity", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ALWAYS")
    ps.add_property("invMass", "walberla::real_t", defValue="1_r", syncMode="ON_GHOST_CREATION")
    ps.add_property("force", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="NEVER")
    ps.add_property("oldForce", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("charge", "walberla::real_t", defValue="0_r", syncMode="ALWAYS")
    ...
    ps.add_property("angularVelocity", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ALWAYS")
    ps.add_property("torque", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="NEVER")
    ps.add_property("oldTorque", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")

    ps.add_property("radiusAtTemperature", "walberla::real_t", defValue="0_r", syncMode="ALWAYS")
    ...
    ps.add_property("temperature", "walberla::real_t", defValue="0_r", syncMode="ALWAYS")
    ps.add_property("heatFlux", "walberla::real_t", defValue="0_r", syncMode="NEVER")

    ps.add_property("numContacts", "uint_t", defValue="0", syncMode="NEVER")

    # Properties for HCSITS
    ps.add_property("dv", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="NEVER")
    ps.add_property("dw", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="NEVER")

    # Properties for lbm_mesapd_coupling:
    ps.add_property("hydrodynamicForce", "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("hydrodynamicTorque", "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("oldHydrodynamicForce", "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("oldHydrodynamicTorque", "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("electrostaticForce", "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ...
    ps.add_property("virtualMass",                  "walberla::real_t",        defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("invMassIncludingVirtual",      "walberla::real_t",        defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("oldLinearAcceleration",        "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("invInertiaBF",                 "walberla::mesa_pd::Mat3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("virtualInertiaBF",             "walberla::mesa_pd::Mat3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("invInertiaBFIncludingVirtual", "walberla::mesa_pd::Mat3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("oldAngularAcceleration",       "walberla::mesa_pd::Vec3", defValue="0_r",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ...
    ch.add_property("tangentialSpringDisplacement", "walberla::mesa_pd::Vec3", defValue="0_r")
    ch.add_property("isSticking", "bool", defValue="false")
    ch.add_property("impactVelocityMagnitude", "real_t", defValue="0_r")
    ...
    cs.add_property("distance", "real_t", defValue="1_r")
    cs.add_property("normal", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("position", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("t", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("o", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("r1", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("r2", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("mu", "real_t", defValue="0_r")
    cs.add_property("p", "walberla::mesa_pd::Vec3", defValue="0_r")
    cs.add_property("diag_nto", "walberla::mesa_pd::Mat3", defValue="0_r")
    cs.add_property("diag_nto_inv", "walberla::mesa_pd::Mat3", defValue="0_r")
    cs.add_property("diag_to_inv", "walberla::mesa_pd::Mat2", defValue="0_r")
    cs.add_property("diag_n_inv", "real_t", defValue="0_r")
    cs.add_property("p", "walberla::mesa_pd::Vec3", defValue="0_r")
    ...
    ftn.add_property('force', 'mesa_pd::Vec3', 'Vec3(0_r)')
    ftn.add_property('torque', 'mesa_pd::Vec3', 'Vec3(0_r)')
    hftn = mpd.add(mpi.PropertyNotification('HydrodynamicForceTorqueNotification'))
    hftn.add_property('hydrodynamicForce', 'mesa_pd::Vec3', 'Vec3(0_r)')
    hftn.add_property('hydrodynamicTorque', 'mesa_pd::Vec3', 'Vec3(0_r)')
    eftn = mpd.add(mpi.PropertyNotification('ElectrostaticForceNotification'))
    eftn.add_property('electrostaticForce', 'mesa_pd::Vec3', 'Vec3(0_r)')
    hfn = mpd.add(mpi.PropertyNotification('HeatFluxNotification'))
    hfn.add_property('heatFlux', 'real_t', '0_r')
