...
if __name__ == '__main__':
    ...
    ps.add_property("oldHydrodynamicTorque", "walberla::mesa_pd::Vec3", defValue="real_t(0)",
                    syncMode="ON_OWNERSHIP_CHANGE")
    ps.add_property("electrostaticForce", "walberla::mesa_pd::Vec3", defValue="real_t(0)", syncMode="ON_OWNERSHIP_CHANGE")
    ...
    #eftn.add_property('electrostaticTorque', 'mesa_pd::Vec3', 'Vec3(real_t(0))')
