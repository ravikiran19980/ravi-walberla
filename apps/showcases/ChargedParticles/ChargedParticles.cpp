...
int main(int argc, char** argv)
{
   ...
   WALBERLA_LOG_INFO_ON_ROOT(" - particle generation spacing = " << particleGenerationSpacing_x << " "
                                                                 << particleGenerationSpacing_y << " "
                                                                 << particleGenerationSpacing_z);
   ...
   BlockDataID pdfFieldID = lbm::addPdfFieldToStorage< LatticeModel_T >(
      blocks, "pdf field", latticeModel, Vector3(0, 0, 0), densityFluid, uint_t(1), field::fzyx);
