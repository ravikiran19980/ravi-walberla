...
// Setup of the energy LBM communication for synchronizing the energy pdf field between neighboring blocks
   ...
   //pystencils::compute_temperature_field compute_temperature_field(particleAndVolumeFractionSoA_energy.BFieldID,densityConcentrationFieldCPUGPUID,Cp_f,Cp_s,densityFluid,densityParticle);
