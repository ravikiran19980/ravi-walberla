...
int main( int argc, char **argv )
{
   ...
   for( auto cfg = python_coupling::configBegin( argc, argv ); cfg != python_coupling::configEnd(); ++cfg )
   {
      ...
      // Creating fields
      BlockDataID pdfFieldCpuID = field::addToStorage< PdfField_T >( blocks, "pdfs cpu", 0_r, field::fzyx);
      BlockDataID velFieldCpuID = field::addToStorage< VelocityField_T >( blocks, "vel", 0_r, field::fzyx);
