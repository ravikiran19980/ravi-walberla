...
int main(int argc, char **argv)
{
   ...
   auto sp = createSphere(*ps, Vec3(1, 0, std::sqrt(4_r - 1_r)));
      ...
      ps->forEachParticle(false,
                          ...
                          *ac,
                          [&](const size_t idx1)
                          {
                             ...
                             {
                                ac->setForce(idx1, Vec3(0,0,-1) * 9.81_r / ac->getInvMass(idx1));
                             }
                          });
   ...
   WALBERLA_LOG_DEVEL_VAR(sp->getPosition());
   WALBERLA_CHECK_GREATER(sp->getPosition()[2], 1_r);
   ...
   WALBERLA_LOG_DEVEL_VAR(sp->getPosition());
   WALBERLA_CHECK_LESS(sp->getPosition()[2], 1_r);
