...
void checkSphereSphereCollision( )
{
   ...
   sp0.setPosition( Vec3(0_r, 0_r, 0_r) );
   ...
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getContactPoint(), dir * shift * 0.5_r);
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getContactNormal(), -dir );
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getPenetrationDepth(), shift - 1_r );
...
void checkSphereHalfSpaceCollision( )
{
   ...
   WALBERLA_CHECK_EQUAL( acd.getIdx1(), 0);
   WALBERLA_CHECK_EQUAL( acd.getIdx2(), 1);
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getContactPoint(), dir * shift * 1.0_r);
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getContactNormal(), -dir );
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getPenetrationDepth(), shift - 1_r );
   ...
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getContactNormal(), -Vec3(1_r, 0_r, 0_r) );
   WALBERLA_CHECK_FLOAT_EQUAL( acd.getPenetrationDepth(), pos[0] - 1_r );
}
...
int main( int argc, char ** argv )
{
   ...
   walberla::mesa_pd::checkRotation( Vec3(1_r, 0_r, 0_r),
                                     Vec3(0_r, 1_r, 0_r) );
