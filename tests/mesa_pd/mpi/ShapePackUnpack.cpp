...
void checkBox()
{
   ...
   std::shared_ptr<data::BaseShape> bs0 = std::make_shared<data::Box>(Vec3(2.53_r, 4.53_r, 3.53_r));
   bs0->updateMassAndInertia(123_r);
...
void checkCylindricalBoundary()
{
   ...
   std::shared_ptr<data::BaseShape> bs0 = std::make_shared<data::CylindricalBoundary>(9.99_r,
                                                                                      Vec3(2.53_r, 4.53_r, 3.53_r).getNormalized());
   bs0->updateMassAndInertia(123_r);
   std::shared_ptr<data::BaseShape> bs1 = nullptr;
...
void checkEllipsoid()
{
   ...
   std::shared_ptr<data::BaseShape> bs0 = std::make_shared<data::Ellipsoid>(Vec3(2.53_r, 4.53_r, 3.53_r));
   bs0->updateMassAndInertia(123_r);
   std::shared_ptr<data::BaseShape> bs1 = nullptr;
...
void checkHalfSpace()
{
   ...
   std::shared_ptr<data::BaseShape> bs0 = std::make_shared<data::HalfSpace>(Vec3(2.53_r, 4.53_r, 3.53_r));
   bs0->updateMassAndInertia(123_r);
   std::shared_ptr<data::BaseShape> bs1 = nullptr;
...
void checkSphere()
{
   ...
   std::shared_ptr<data::BaseShape> bs0 = std::make_shared<data::Sphere>(2.53_r);
   bs0->updateMassAndInertia(123_r);
   std::shared_ptr<data::BaseShape> bs1 = nullptr;
