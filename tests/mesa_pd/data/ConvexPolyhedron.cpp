...
int main( int argc, char** argv )
{
   ...
   mesh1ParticleShape->updateMassAndInertia(1_r);
   ...
   WALBERLA_CHECK_FLOAT_EQUAL(massPropCentroid, Vector3<real_t>(0_r))
   ...
   WALBERLA_CHECK_FLOAT_EQUAL(meshCubeShape.getBoundingSphereRadius(), 1_r * std::sqrt(3_r) * 0.5_r);
   ...
   WALBERLA_CHECK_FLOAT_EQUAL_EPSILON(bunnyRadius, std::sqrt(maxSqRadius), 1e-4_r);
   ...
   AABB supportTestAABB(mesa_pd::Vec3(-1_r), mesa_pd::Vec3(1_r));
   std::mt19937 rng;
