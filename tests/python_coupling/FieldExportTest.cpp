...
int main( int argc, char ** argv )
{
   ...
   auto srcDoubleFieldID = field::addToStorage< GhostLayerField<real_t, 3> >( blocks, "srcDoubleFieldID", 0.0_r, field::fzyx, 1 );
   auto dstDoubleFieldID = field::addToStorage< GhostLayerField<real_t, 3> >( blocks, "dstDoubleFieldID", 0.0_r, field::fzyx, 1 );
   // random init
   for( auto blockIt = blocks->begin(); blockIt != blocks->end(); ++blockIt )
   {
      ...
      for( auto cellIt = srcDoubleField->begin(); cellIt != srcDoubleField->end(); ++cellIt )
         *cellIt = math::realRandom( 0.0_r, 42.0_r );
   }
