...
int main( int argc, char** argv )
{
   ...
   BlockDataID uId = field::addToStorage< PdeField_T >( blocks, "u", 0_r, field::fzyx, uint_t{1} );
   BlockDataID rId = field::addToStorage< PdeField_T >( blocks, "r", 0_r, field::fzyx, uint_t{1} );
   BlockDataID dId = field::addToStorage< PdeField_T >( blocks, "d", 0_r, field::fzyx, uint_t{1} );
   BlockDataID zId = field::addToStorage< PdeField_T >( blocks, "z", 0_r, field::fzyx, uint_t{1} );

   initU( blocks, uId );

   BlockDataID fId = field::addToStorage< PdeField_T >( blocks, "f", 0_r, field::fzyx, uint_t{1} );
