...
{
   static const geometry::Sphere UNIT_SPHERE( math::Vector3<real_t>( 0, 0, 0 ), 1_r );
   ...
   WALBERLA_CHECK_LESS( std::fabs( intersectionRadius - 1_r ), EPSILON );
...
void testAABB()
{
   ...
   static const math::Vector3<real_t> ZERO( 0_r, 0_r, 0_r );
   static const math::Vector3<real_t> UNIT( 1_r, 1_r, 1_r );
   static const real_t EPSILON = 1e-4_r;
   ...
   {
      const math::AABB outerAABB = aabbIt->getScaled( 2_r );
