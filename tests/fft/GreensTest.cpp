...
int main (int argc, char** argv)
{
   ...
   BlockDataID originalFieldId = field::addToStorage<Field_T>( blocks, "original", 0_r, field::fzyx, 1 );
   BlockDataID fftFieldId = field::addToStorage<Field_T>( blocks, "result", 0_r, field::fzyx, 1 );
