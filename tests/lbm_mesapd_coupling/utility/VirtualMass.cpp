...
int main( int argc, char **argv )
{
   ...
   WALBERLA_CHECK_FLOAT_EQUAL(1._r / (accessor.getMass(idx) + sphereVirtualMass),
   ...
   accessor.setForce(idx, Vector3(1_r));
