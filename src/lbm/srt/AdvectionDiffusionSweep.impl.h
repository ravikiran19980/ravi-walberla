...
void AdvectionDiffusionSweep< LM_AdvDiff, VelocityAdapter_T, FlagField_T, VectorField_T >::operator() ( IBlock * block )
{
   ...
   const real_t omega_st = 1_r - omega_eq;
...
void AdvectionDiffusionSweep< LM_AdvDiff, VelocityAdapter_T, FlagField_T, VectorField_T >::operator() ( IBlock * block )
{
   ...
   const real_t omega_eq = lm.collisionModel( ).omega( );
   const real_t omega_st = 1_r - omega_eq;
   const real_t omega_dt = 3_r - real_c( 1.5 )*omega_eq;
...
void AdvectionDiffusionSweep< LM_AdvDiff, VelocityAdapter_T, FlagField_T, VectorField_T >::operator()( IBlock * const block )
{
   ...
   const real_t  omega_w0( 3_r * ( 1_r / 3_r ) * omega );
...
void AdvectionDiffusionSweep< LM_AdvDiff, VelocityAdapter_T, FlagField_T, VectorField_T >::operator()( IBlock * const block )
{
   ...
   const real_t omega_dt1( 3_r * ( 1_r / 18_r ) * ( 1_r - ( 1_r / 2_r ) * omega ) );
   const real_t omega_dt2( 3_r * ( 1_r / 36_r ) * ( 1_r - ( 1_r / 2_r ) * omega ) );
