...
template< typename CM, bool C, typename FM, int EAO > const real_t D3Q19<CM,C,FM,EAO>::w_0 = 1.0_r / 3.0_r;
...
template< typename CM, bool C, typename FM, int EAO > const real_t D3Q19<CM,C,FM,EAO>::w[19] = { 1.0_r / 3.0_r,   // C
                                                                                                 1.0_r / 18.0_r,   // N
                                                                                                 1.0_r / 18.0_r,   // S
                                                                                                 1.0_r / 18.0_r,   // W
                                                                                                 1.0_r / 18.0_r,   // E
...
// must match with the static array 'dir' in stencil::D3Q19
template< typename CM, bool C, typename FM, int EAO > const real_t D3Q19<CM,C,FM,EAO>::wInv[19] = { 3.0_r,   // C
                                                                                                    18.0_r,   // N
                                                                                                    18.0_r,   // S
                                                                                                    18.0_r,   // W
                                                                                                    18.0_r,   // E
