...
public:
   struct Parameters {
      ...
      walberla::mesa_pd::Vec3 oldForce_ {0_r};
      walberla::mesa_pd::Vec3 oldTorque_ {0_r};
      walberla::mesa_pd::Vec3 hydrodynamicForce_ {0_r};
      walberla::mesa_pd::Vec3 hydrodynamicTorque_ {0_r};
      walberla::mesa_pd::Vec3 oldHydrodynamicForce_ {0_r};
      walberla::mesa_pd::Vec3 oldHydrodynamicTorque_ {0_r};
      walberla::mesa_pd::Vec3 electrostaticForce_ {0_r};
      walberla::real_t totalDisplacement_ {0_r};
      walberla::real_t collisionForceNorm_ {0_r};
      walberla::real_t virtualMass_ {0_r};
      walberla::real_t invMassIncludingVirtual_ {0_r};
      walberla::mesa_pd::Vec3 oldLinearAcceleration_ {0_r};
      walberla::mesa_pd::Mat3 invInertiaBF_ {0_r};
      walberla::mesa_pd::Mat3 virtualInertiaBF_ {0_r};
      walberla::mesa_pd::Mat3 invInertiaBFIncludingVirtual_ {0_r};
      walberla::mesa_pd::Vec3 oldAngularAcceleration_ {0_r};
   };
