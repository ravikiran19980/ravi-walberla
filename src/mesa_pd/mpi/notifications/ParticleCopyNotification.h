...
public:
   struct Parameters
   {
      ...
      walberla::mesa_pd::Vec3 position {0_r};
      walberla::real_t interactionRadius {0_r};
      walberla::mesa_pd::data::particle_flags::FlagT flags {};
      int owner {-1};
      std::unordered_set<walberla::mpi::MPIRank> ghostOwners {};
      walberla::mesa_pd::Vec3 linearVelocity {0_r};
      walberla::real_t invMass {1_r};
      walberla::mesa_pd::Vec3 oldForce {0_r};
      walberla::real_t charge {0_r};
      size_t shapeID {};
      ...
      walberla::mesa_pd::Vec3 angularVelocity {0_r};
      walberla::mesa_pd::Vec3 oldTorque {0_r};
      walberla::real_t radiusAtTemperature {0_r};
      uint_t type {0};
      std::map<walberla::id_t, walberla::mesa_pd::data::ContactHistory> oldContactHistory {};
      walberla::real_t temperature {0_r};
      walberla::mesa_pd::Vec3 hydrodynamicForce {0_r};
      walberla::mesa_pd::Vec3 hydrodynamicTorque {0_r};
      walberla::mesa_pd::Vec3 oldHydrodynamicForce {0_r};
      walberla::mesa_pd::Vec3 oldHydrodynamicTorque {0_r};
      walberla::mesa_pd::Vec3 electrostaticForce {0_r};
      walberla::real_t totalDisplacement {0_r};
      walberla::real_t collisionForceNorm {0_r};
      walberla::real_t virtualMass {0_r};
      walberla::real_t invMassIncludingVirtual {0_r};
      walberla::mesa_pd::Vec3 oldLinearAcceleration {0_r};
      walberla::mesa_pd::Mat3 invInertiaBF {0_r};
      walberla::mesa_pd::Mat3 virtualInertiaBF {0_r};
      walberla::mesa_pd::Mat3 invInertiaBFIncludingVirtual {0_r};
      walberla::mesa_pd::Vec3 oldAngularAcceleration {0_r};
      int64_t clusterID {-1};
      int64_t segmentID {-1};
   };
