...
inline ParticleStorage::iterator ParticleStorage::create(const id_t& uid)
{
   ...
   position_.emplace_back(0_r);
   interactionRadius_.emplace_back(0_r);
   flags_.emplace_back();
   owner_.emplace_back(-1);
   ghostOwners_.emplace_back();
   linearVelocity_.emplace_back(0_r);
   invMass_.emplace_back(1_r);
   force_.emplace_back(0_r);
   oldForce_.emplace_back(0_r);
   charge_.emplace_back(0_r);
   shapeID_.emplace_back();
   baseShape_.emplace_back(make_shared<walberla::mesa_pd::data::BaseShape>());
   rotation_.emplace_back();
   angularVelocity_.emplace_back(0_r);
   torque_.emplace_back(0_r);
   oldTorque_.emplace_back(0_r);
   radiusAtTemperature_.emplace_back(0_r);
   ...
   temperature_.emplace_back(0_r);
   heatFlux_.emplace_back(0_r);
   numContacts_.emplace_back(0);
   dv_.emplace_back(0_r);
   dw_.emplace_back(0_r);
   hydrodynamicForce_.emplace_back(0_r);
   hydrodynamicTorque_.emplace_back(0_r);
   oldHydrodynamicForce_.emplace_back(0_r);
   oldHydrodynamicTorque_.emplace_back(0_r);
   electrostaticForce_.emplace_back(0_r);
   totalDisplacement_.emplace_back(0_r);
   collisionForceNorm_.emplace_back(0_r);
   virtualMass_.emplace_back(0_r);
   invMassIncludingVirtual_.emplace_back(0_r);
   oldLinearAcceleration_.emplace_back(0_r);
   invInertiaBF_.emplace_back(0_r);
   virtualInertiaBF_.emplace_back(0_r);
   invInertiaBFIncludingVirtual_.emplace_back(0_r);
   oldAngularAcceleration_.emplace_back(0_r);
