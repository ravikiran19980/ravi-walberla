...
inline ContactStorage::iterator ContactStorage::create(const id_t& uid)
{
   ...
   distance_.emplace_back(1_r);
   normal_.emplace_back(0_r);
   position_.emplace_back(0_r);
   t_.emplace_back(0_r);
   o_.emplace_back(0_r);
   r1_.emplace_back(0_r);
   r2_.emplace_back(0_r);
   mu_.emplace_back(0_r);
   p_.emplace_back(0_r);
   diag_nto_.emplace_back(0_r);
   diag_nto_inv_.emplace_back(0_r);
   diag_to_inv_.emplace_back(0_r);
   diag_n_inv_.emplace_back(0_r);
   uid_.back() = uid;
