...
protected:
   real_t     mass_         = 0_r;       ///< mass
   real_t     invMass_      = 0_r;       ///< inverse mass
   Mat3       inertiaBF_    = Mat3(0_r); ///< inertia matrix in the body frame
   Mat3       invInertiaBF_ = Mat3(0_r); ///< inverse inertia matrix in the body frame
