...
{
public:
   explicit Box(const Vec3& edgeLength = Vec3(1_r))
...
Vec3 Box::support( const Vec3& bfD ) const
{
   ...
   Vec3 relativSupport = Vec3( math::sign(bfD[0])*edgeLength_[0]*0.5_r,
                               math::sign(bfD[1])*edgeLength_[1]*0.5_r,
                               math::sign(bfD[2])*edgeLength_[2]*0.5_r );
