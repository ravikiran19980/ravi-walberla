...
inline LinearSpringDashpot::LinearSpringDashpot(const uint_t numParticleTypes)
{
   ...
   stiffnessN_.resize(numParticleTypes * numParticleTypes, 0_r);
   stiffnessT_.resize(numParticleTypes * numParticleTypes, 0_r);
   dampingN_.resize(numParticleTypes * numParticleTypes, 0_r);
...
inline real_t LinearSpringDashpot::calcCoefficientOfRestitution(const size_t type1,
                                                                ...
                                                                const real_t effectiveMass)
{
   auto a = 0.5_r * getDampingN(type1, type2) / effectiveMass;
                                                        ...
                                                        const real_t effectiveMass)
{
   ...
   setDampingN  (type1, type2, - 2_r * effectiveMass * lnDryResCoeff / collisionTime );
