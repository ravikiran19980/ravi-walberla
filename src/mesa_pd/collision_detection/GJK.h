...
public:
   ...
   bool doGJKmargin( const Support &geom1, const Support &geom2, const real_t margin = 0_r);
   //@}
   //**********************************************************************************************
...
private:
   ...
   inline bool sameDirection   ( const Vec3& vec1, const Vec3& vec2 ) const { return vec1 * vec2 > 0.0_r; }
