                                         ...
                                         Accessor& ac)
{
   ...
   { //We have a collision
      ...
      contactPoint_ = contactp + 0.5_r * penetrationDepth_ * contactNormal_;
      return true;
   } else
   { //No collision
      return false;
                                         ...
                                         Accessor& ac)
{
   ...
   WALBERLA_CHECK_FLOAT_EQUAL(geo1.getAxis().sqrLength(), 1_r);
   ...
   { //We have a collision
      ...
      normalize(d2);
      contactNormal_ = d2;
      contactPoint_ = farestP + d2 * penetrationDepth_ * 0.5_r;
      return true;
   } else
   { //No collision
      return false;
