...
{
   uint_t const xInt = uint_c( (x - aabb_.xMin()) / aabb_.xSize() * static_cast< real_t >( binaryRawFile_.size()[0] ) + 0.5_r );
   uint_t const yInt = uint_c( (y - aabb_.yMin()) / aabb_.ySize() * static_cast< real_t >( binaryRawFile_.size()[1] ) + 0.5_r );
   uint_t const zInt = uint_c( (z - aabb_.zMin()) / aabb_.zSize() * static_cast< real_t >( binaryRawFile_.size()[2] ) + 0.5_r );
