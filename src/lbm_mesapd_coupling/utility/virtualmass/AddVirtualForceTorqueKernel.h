 ...
 *  ps.add_property("oldLinearAcceleration",  "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 *  ps.add_property("oldAngularAcceleration", "walberla::mesa_pd::Vec3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 */
...
public:
   ...
   void operator()(const size_t idx, Accessor_T& ac) {
      ...
      WALBERLA_CHECK_FLOAT_UNEQUAL(ac.getVirtualMass(idx), 0._r,
