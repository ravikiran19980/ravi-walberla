 ...
 *  ps.addProperty("virtualMass",                  "walberla::real_t",        defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 *  ps.addProperty("invMassIncludingVirtual",      "walberla::real_t",        defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 *  ps.addProperty("virtualInertiaBF",             "walberla::mesa_pd::Mat3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 *  ps.addProperty("invInertiaBFIncludingVirtual", "walberla::mesa_pd::Mat3", defValue="0_r", syncMode="ON_OWNERSHIP_CHANGE")
 */
...
inline void InitializeVirtualMassKernel::operator()(const size_t i, Accessor& ac, const real_t C_v, const real_t C_v_omega,
   ...
   ac.setInvMassIncludingVirtual(i, 1._r / (ac.getMass(i) + virtualMass));
